    ...
    <div className="min-h-screen bg-[#F9FFFF] py-12">
      ...
      <div className="flex flex-wrap justify-center gap-8 px-6">
        ...
        <div className="max-w-sm w-full bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="text-4xl font-bold text-gray-900 mb-6">50€<span className="text-lg font-medium">/month</span></div>
        ...
        <div className="max-w-sm w-full bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="text-4xl font-bold text-gray-900 mb-6">150€<span className="text-lg font-medium">/month</span></div>
          <ul className="text-gray-700 space-y-3 mb-6">
